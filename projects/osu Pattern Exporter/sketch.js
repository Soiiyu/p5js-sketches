let input, map, hitobjects, cs, start, end, colorOffset, newCombo, gradiant, approachSwitch, followPoint, g1, g2, approachOpacity;
let hitcircle, overlay, numbers, approach;
let colors = [
  [255, 242, 140],
  [101, 252, 171],
  [148, 120, 255],
...
function handleFile(file) {
  ...
  hitobjects = map
    ...
    .map((l) => {
      ...
      counter++
      return { x, y, time, type, combo, newCombo };
    });
